...
/** Cross-tab of the two variables, joined per participant, as heatmap columns. */
function buildHeatmapData(rawData: PhenotypicalDataPoint[], var1Name: string, var2Name: string) {
...
export default function CategoricalCategoricalChart({ rawData, var1Name, var2Name }: Props) {
  const heatmapData = buildHeatmapData(rawData, var1Name, var2Name);
