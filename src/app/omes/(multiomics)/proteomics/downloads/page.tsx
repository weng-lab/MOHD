...
export type ProteomicsDownloadsProps = {
    rows: RNAMetadata;
...
const ProteomicsDownloads = () => {
    ...
    const SharedProteomicsDownloadsProps: ProteomicsDownloadsProps = useMemo(
        () => ({
            rows,
            RNAData,
            site,
    ...
    return (
        <Stack direction="column" spacing={2}>
            <OmeDownloadsControls 
                ...
                setSex={setSex} 
            />
            <ProteomicsDownloadsTable {...SharedProteomicsDownloadsProps} />
        </Stack>
    )
}
