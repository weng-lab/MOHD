...
const WGBSDimensionalityTable = ({ rows, tableProps }: SharedWGBSDimenionalityProps) => {
  ...
  return (
    <Table {...syncedTableProps} label={<Typography noWrap>WGBS Dimensionality Reduction</Typography>} rows={rows} />
  );
};
