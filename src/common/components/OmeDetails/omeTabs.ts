...
export const OME_TABS: Record<OmesDataType, TabItem[]> = {
    ...
    WGBS: [
        ...
        { value: "genomeBrowser", label: "Genome Browser", icon: genomeBrowserIcon, href: "/omes/WGBS/genomeBrowser" },
    ...
    ATAC: [
        ...
        { value: "genomeBrowser", label: "Genome Browser", icon: genomeBrowserIcon, href: "/omes/ATAC/genomeBrowser" },
    ...
    RNA: [
        ...
        { value: "genomeBrowser", label: "Genome Browser", icon: genomeBrowserIcon, href: "/omes/RNA/genomeBrowser" },
    ...
    metallomics: [
        { value: "dimensionalityReduction", label: "Dimensionality Reduction", icon: dimensionalityReductionIcon, href: "/omes/metallomics/dimensionalityReduction" },
    ],
};
