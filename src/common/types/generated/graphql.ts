...
export type Fetch_Phenotypical_DataQuery = { __typename?: 'Query', phenotypical_data: Array<{ __typename?: 'PhenotypicalData', participant_id: string, participant_profile_dss: string, participant_profile_dss_internal_id?: number | null, value_numeric?: number | null, value_text?: string | null, variable_name: string, variable_status?: string | null, assigned_category?: string | null }> };
